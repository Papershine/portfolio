...
export default function TiltedCard({
  ...
  return (
    ...
    >
      <motion.div
        className="tilted-card-inner w-full h-80 md:h-96 rounded-2xl border-gray-300 dark:border-gray-700 border-1
                    glow-border-spin"
        style={{
          rotateX,
          rotateY,
      ...
      >
        <motion.img
          src={imageSrc}
          alt={altText}
          className="tilted-card-img w-full h-80 md:h-96 rounded-2xl object-center object-cover bg-gray-100/80 dark:bg-gray-900/80"
        />
